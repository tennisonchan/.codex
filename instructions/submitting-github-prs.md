...
6. PR: push the branch, open the PR with a clear description, linked issues, UI media, and a “Tests” section. Assign reviewer by `gh pr create --reviewer truewind-engineering`.
