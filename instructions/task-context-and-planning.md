...
### Keep it live
- Append notes as decisions happen (don’t wait until the end). Include who decided, what changed, and links to Slack/GitHub messages.
- Record blockers and the escalation you made (channel + time) if you ping Slack.
